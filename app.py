...
# Change Name & Logo
st.set_page_config(page_title="Multi Disease Prediction", page_icon="🧊", layout="centered", initial_sidebar_state="expanded")

# Hiding Streamlit add-on
hide_st_style = """
            <style>
...
background_image_url = "images\\v870-tang-36.jpg" # Replace with your image URL
